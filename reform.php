...
$hero = [
    ...
    'image_alt' => lang() === 'bn' ? 'রাজনৈতিক গণসংযোগ' : 'Political outreach',
    'actions' => [
        ['url' => 'https://www.bnpbd.org/31-points/', 'label' => lang() === 'bn' ? 'অফিসিয়াল ৩১ দফা' : 'Official 31 points', 'icon' => 'external-link', 'class' => 'button'],
