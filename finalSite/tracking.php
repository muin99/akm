...
$hero = ['eyebrow' => t('public_service'), 'title' => lang() === 'bn' ? 'আবেদন ট্র্যাক করুন' : 'Track a request', 'intro' => lang() === 'bn' ? 'ট্র্যাকিং কোডে শুধু অবস্থা ও অনুমোদিত পাবলিক নোট দেখা যায়।' : 'Tracking shows only status and approved public notes.'];
require __DIR__ . '/includes/header.php';
?>
<main id="main">
    <?php require __DIR__ . '/includes/page-hero.php'; ?>
    <section class="section pt-0"><div class="page-shell narrow"><div class="form-panel">
